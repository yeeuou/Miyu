...
public class DefaultMod
	...
	// Colors (RGB)
	// Character Color
	public static final Color DODGE_BLUE = CardHelper.getColor(30.0f, 144.0f, 255.0f);
	...
	private static final String ATTACK_DEFAULT_GRAY = "MiyuResources/images/512/bg_attack_default_gray.png";
	private static final String SKILL_DEFAULT_GRAY = "MiyuResources/images/512/bg_skill_default_gray.png";
	private static final String POWER_DEFAULT_GRAY = "MiyuResources/images/512/bg_power_default_gray.png";

	private static final String ENERGY_ORB_DEFAULT_GRAY = "MiyuResources/images/512/card_default_gray_orb.png";
	private static final String CARD_ENERGY_ORB = "MiyuResources/images/512/card_small_orb.png";

	private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "MiyuResources/images/1024/bg_attack_default_gray.png";
	private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "MiyuResources/images/1024/bg_skill_default_gray.png";
	private static final String POWER_DEFAULT_GRAY_PORTRAIT = "MiyuResources/images/1024/bg_power_default_gray.png";
	private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "MiyuResources/images/1024/card_default_gray_orb.png";

	// Character assets
	private static final String THE_DEFAULT_BUTTON = "MiyuResources/images/charSelect/DefaultCharacterButton.png";
	private static final String THE_DEFAULT_PORTRAIT = "MiyuResources/images/charSelect/DefaultCharacterPortraitBG.png";
	public static final String THE_DEFAULT_SHOULDER_1 = "MiyuResources/images/char/defaultCharacter/shoulder.png";
	public static final String THE_DEFAULT_SHOULDER_2 = "MiyuResources/images/char/defaultCharacter/shoulder2.png";
	public static final String THE_DEFAULT_CORPSE = "MiyuResources/images/char/defaultCharacter/corpse.png";

	// Mod Badge - A small icon that appears in the mod settings menu next to your mod.
	public static final String BADGE_IMAGE = "MiyuResources/images/Badge.png";

	// Atlas and JSON files for the Animations
	public static final String THE_DEFAULT_SKELETON_ATLAS = "MiyuResources/images/char/defaultCharacter/Spriter/Miyustand.atlas";
	public static final String THE_DEFAULT_SKELETON_JSON = "MiyuResources/images/char/defaultCharacter/Spriter/Miyustand.json";
	...
	public DefaultMod() {
		 ...
		 * __| || (_)_\(_) \| |/ __| __| | \/ |/ _ \| \ |_ _|| (_) | (__| __ |/ _ \ | .` | (_ | _| | |\/| | (_) | |) | |
		...
		// 2. Click on the localization > eng folder and press ctrl+shift+r, then select "Directory" (rather than in
		// Project) and press alt+c (or mark the match case option)
		// replace all instances of theDefault with yourModID, and all instances of thedefault with yourmodid (the same
		// but all lowercase).
		// Because your mod ID isn't the default. Your cards (and everything else) should have Your mod id. Not mine.
		// It's important that the mod ID prefix for keywords used in the cards descriptions is lowercase!

		// 3. Scroll down (or search for "ADD CARDS") till you reach the ADD CARDS section, and follow the TODO
		// instructions

		// 4. FINALLY and most importantly: Scroll up a bit. You may have noticed the image locations above don't use
		// getModID()
		// Change their locations to reflect your actual ID rather than theDefault. They get loaded before getID is a
		// thing.
		...
		BaseMod.addColor(TheDefault.Enums.COLOR_GRAY, DODGE_BLUE, DODGE_BLUE, DODGE_BLUE, DODGE_BLUE, DODGE_BLUE,
				DODGE_BLUE, DODGE_BLUE, ATTACK_DEFAULT_GRAY, SKILL_DEFAULT_GRAY, POWER_DEFAULT_GRAY,
	...
	public void receiveEditCharacters() {
		...
		BaseMod.addCharacter(new TheDefault("the Default", TheDefault.Enums.THE_DEFAULT), THE_DEFAULT_BUTTON,
				THE_DEFAULT_PORTRAIT, TheDefault.Enums.THE_DEFAULT);
	...
	public void receivePostInitialize() {
		...
		BaseMod.addPower(Covered.class, Covered.POWER_ID);
		BaseMod.addPower(Pebble.class, Pebble.POWER_ID);
	...
	public void receiveEditRelics() {
		...
		// Of note is that the bard mod uses it's own custom relic class (not dissimilar to our AbstractDefaultCard
		// class for cards) that adds the 'color' field,
	...
	public void receiveEditCards() {
		...
		// Add the cards
		// Don't delete these default cards yet. You need 1 of each type and rarity (technically) for your game not to
		// crash
		...
		new AutoAdd("Miyu") // ${project.artifactId}
				.packageFilter("Miyu.cards") // filters to any class in the same package as AbstractDefaultCard, nested
												// packages included
	...
	public void receiveEditStrings() {
		...
		// CardStrings
		BaseMod.loadCustomStringsFile(CardStrings.class, pathByLanguage + "DefaultMod-Card-Strings.json");

		// PowerStrings
		BaseMod.loadCustomStringsFile(PowerStrings.class, pathByLanguage + "DefaultMod-Power-Strings.json");

		// RelicStrings
		BaseMod.loadCustomStringsFile(RelicStrings.class, pathByLanguage + "DefaultMod-Relic-Strings.json");

		// Event Strings
		BaseMod.loadCustomStringsFile(EventStrings.class, pathByLanguage + "DefaultMod-Event-Strings.json");

		// PotionStrings
		BaseMod.loadCustomStringsFile(PotionStrings.class, pathByLanguage + "DefaultMod-Potion-Strings.json");

		// CharacterStrings
		BaseMod.loadCustomStringsFile(CharacterStrings.class, pathByLanguage + "DefaultMod-Character-Strings.json");

		// OrbStrings
		BaseMod.loadCustomStringsFile(OrbStrings.class, pathByLanguage + "DefaultMod-Orb-Strings.json");

		/*
		 * uistring을 확장 추가 메세지를 만들 수 있음. by josh
		 */
	...
	public void receiveEditKeywords() {
		...
		//
		// If you're using multiword keywords, the first element in your NAMES array in your keywords-strings.json has
		// to be the same as the PROPER_NAME.
		// That is, in Card-Strings.json you would have #yA_Long_Keyword (#y highlights the keyword in yellow).
		// In Keyword-Strings.json you would have PROPER_NAME as A Long Keyword and the first element in NAMES be a long
		// keyword, and the second element be a_long_keyword

		String pathByLanguage; // 한글 키워드 불러오기
		switch (Settings.language) {
			case KOR :
				pathByLanguage = getModID() + "Resources/localization/kor/DefaultMod-Keyword-Strings.json";
				break;
			default :
				pathByLanguage = getModID() + "Resources/localization/eng/DefaultMod-Keyword-Strings.json";
		}

		Gson gson = new Gson();
		String json = Gdx.files.internal(pathByLanguage).readString(String.valueOf(StandardCharsets.UTF_8));
		...
		if (keywords != null) {
			for (Keyword keyword : keywords) {
				...
				// getModID().toLowerCase() makes your keyword mod specific (it won't show up in other cards that use
				// that word)
			}
		}
	}
